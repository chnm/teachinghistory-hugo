...
date: '2010-07-22T17:51:04'
lastmod: '2017-10-06T15:21:32'
content_type: ask_a_digital_historian
draft: false
drupal_nid: 24122
question: Have the tools of new media discovered anything new which resulted in revisions?
  Have the tools uncovered new information that has changed historical views? Have
  the tools been used to manipulate the truth so a view of reality has changed? Where
  would I find such information?
url: /digital-classroom/ask-a-digital-historian/24122
featured: true
author_bio: Robert Townsend is the assistant director for research at the American
  Historical Association (AHA). He received his PhD from George Mason University in
  2009.
image_fid: '6159'
splash_image_fid: '6160'
author_image_fid: '6161'
summary: New media tools—invaluable resources or menaces of the digital age?
splash_image: /files/splash-adh-newmedia.jpg
image: /files/lesson_image/image-adh-newmedia.jpg
author_image: /files/author_image/Robert-T-Author.jpg
tags:
- presentation
- research
- visualization
...
Some of the possibilities in these new forms of visualization can be seen in the article ["The Differences Slavery Made"](http://www2.vcdh.virginia.edu/AHR/) by William Thomas and Ed Ayers, which used Geographic Information Systems to plot relationships between different groups in the Shenandoah Valley. This is one of the most visible cases where new mapping technologies provided opportunities to see the past in new ways, but this sort of work is beginning to appear in numerous printed works, as well. Franco Morreti and others are developing similar techniques to peer into large masses of textual data.
...
Nevertheless, many of the book-like projects can pair innovative analyses with deep archives of visual materials (see for instance Helena Pohlandt McCormick's [*'I Saw a Nightmare…' Doing Violence to Memory: The Soweto Uprising, June 16, 1976*](http://www.gutenberg-e.org/pohlandt-mccormick/)). And conversely, many of the digital collection projects are shaped by significant interpretations in the way the materials are gathered and presented (see for instance the Center for History and New Media's [*Gulag: Many Days, Many Lives*](http://gulaghistory.org/)).
...
Cohen, Daniel J and Roy Rosenzweig. [*Digital History: A Guide to Gathering, Preserving, and Presenting the Past on the Web*](http://chnm.gmu.edu/digitalhistory/). Philadelphia: University of Pennsylvania, 2006.  

Knowles, Anne Kelly and Amy Hillier, eds. [*Placing History: How Maps, Spatial Data, and GIS Are Changing Historical Scholarship*](http://books.google.com/books?id=VN1v7rzhSQEC&source=gbs_navlinks_s). Redlands, CA: ESRI, Inc., 2008.
 
