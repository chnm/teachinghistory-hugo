...
A: Teachinghistory.org is funded under the Teaching American History grant program with a central focus on U.S. history. However, much of U.S. history does intersect with the world history curriculum, so you can find some valuable world history content on Teachinghistory.org. Examples include: the [Columbian Exchange](/nhec-blog/24296), the [African Diaspora](/history-content/website-reviews/14796), [the first Barbary War](/best-practices/examples-of-historical-thinking/24298), [World War I](/teaching-materials/lesson-plan-reviews/20190) , and the [Cuban Missile Crisis](/nhec-blog/23484) during the Cold War, among others.

Additionally, all of the [teaching methods](/best-practices) found on Teachinghistory.org can be used to teach both U.S. or world history.
