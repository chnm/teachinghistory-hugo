...
Teachinghistory.org goes beyond easy access to content and resources. It also demonstrates innovative ways to teach about the past. [Lesson Plan Reviews](/teaching-materials/lesson-plan-reviews) provide good models and a rubric for assessing a lesson's quality. Reviews help you think about how to choose from the millions of lessons available online, including those you find through our [Lesson Plan Gateway](/teaching-materials/gateway-history-lesson-plans). [Teaching Guides](/teaching-materials/teaching-guides) offer a range of strategies from using blogs in the classroom to creating structured academic controversy. Watch [video of historians](/best-practices/examples-of-historical-thinking) in action talking about how they make sense of the past. This [clip](/best-practices/examples-of-historical-thinking/22890) focuses on a 1957 market report about selling more potato chips to American consumers. [Using Primary Sources](/best-practices/using-primary-sources) focuses on tools for analyzing evidence of the past from letters to objects to film. Find [handouts](/best-practices/using-primary-sources/14578) from the National Archives or good [questions to ask of advertisements](/best-practices/using-primary-sources/14566). [Teaching with Textbooks](/best-practices/teaching-with-textbooks) presents creative ways to use the tools at your fingertips. [Questioning Textbook Authority](/best-practices/teaching-with-textbooks/20571), for example, outlines steps for teaching students to read critically and to ask questions of all sources.
