...
date: '2011-11-18T17:16:37'
lastmod: '2018-04-24T10:12:07'
content_type: lesson_plan_reviews
draft: false
drupal_nid: 25315
aliases:
- /teaching-materials/lesson-plan-reviews/25315
flexibility_scale: '1'
topic: 'The Road to Pearl Harbor: The United States and East Asia, 1915-1941'
website_url: http://edsitement.neh.gov/curriculum-unit/road-pearl-harbor-united-states-and-east-asia-1915-1941
image_fid: '8565'
splash_image_fid: '8566'
summary: Explore the rise of animosity between the U.S. and Japan through primary
...
| **Historical Content** | Includes historical background? | Significant background provided for each of the four individual lessons. |
| **Historical Content** | Requires students to read and write? | Students read primary documents with multiple writing opportunities. |
| **Analytic Thinking** | Requires analysis/construction of interpretations using evidence? | Yes |
| **Analytic Thinking** | Requires close reading and attention to source information? | Students read source information carefully enough to use in assignments. |
...
| **Lesson Structure** | Defines clear learning goals and progresses logically? | Directions brief and clear. Teachers must design necessary supports. |
