---
title: 'Divining America: Religion in American History'
date: '2011-03-22T13:08:50'
lastmod: '2018-04-24T10:24:10'
content_type: lesson_plan_reviews
draft: false
drupal_nid: 24586
url: /teaching-materials/lesson-plan-reviews/24586
flexibility_scale: '1'
topic: Jewish Immigration
website_url: http://nationalhumanitiescenter.org/tserve/divam.htm
image_fid: '7268'
splash_image_fid: '7269'
summary: Use this essay on Jewish immigration to flesh out a unit on the Civil War
  or immigration.
...
|-------|----------|----------|
| **Historical Content** | Is historically accurate? | Yes. Extensive bibliography provided. |
| **Historical Content** | Includes historical background? | Yes. Centerpiece is a rich background essay. |
| **Historical Content** | Requires students to read and write? | No |
| **Analytic Thinking** | Requires analysis/construction of interpretations using evidence? | Yes. Includes questions that require interpretation. |
| **Analytic Thinking** | Requires close reading and attention to source information? | Yes. Only if students read documents in the additional resources section. |
| **Scaffolding** | Appropriate for stated audience? | Yes. Complex history succinctly explained for busy teachers. |
...
| **Lesson Structure** | Defines clear learning goals and progresses logically? | No |
| **Lesson Structure** | Includes clear directions; realistic for classrooms? | Yes. Provides several entry points into a curriculum. |
