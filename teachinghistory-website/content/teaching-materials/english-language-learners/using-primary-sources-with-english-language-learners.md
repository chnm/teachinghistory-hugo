...
aliases:
- /teaching-materials/english-language-learners/24129
featured: true
image_fid: '6178'
...
4. Hand out resources. Each student needs a writing utensil and a [Source Analysis Sheet](/system/files/Hall_Analysis.pdf). Every student is responsible for analyzing each source. Modeling source analysis for the class will insure that students understand the questions on the analysis sheet.
