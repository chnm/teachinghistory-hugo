...
question: 'I am searching for an unique topic for the National History Day 2010-2011.
  The theme is "Debate and Diplomacy In History: Successes, Failures, Consequences".
  We have to choose a topic that reflects that theme, however, we can choose if we
  want an event that has to do with diplomacy or debate. So, I was wondering if there
...
* National History Day’s [Eight Steps of Historical Research](http://web.archive.org/web/20150215102553/http://www.nationalhistoryday.org:80/EightSteps.htm). Steps 2, 3, and 4 are most relevant to your question.
