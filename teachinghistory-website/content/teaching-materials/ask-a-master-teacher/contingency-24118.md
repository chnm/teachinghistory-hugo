---
title: Contingency
date: '2010-07-19T11:16:58'
lastmod: '2017-10-06T15:21:32'
content_type: ask_an_educator
draft: false
drupal_nid: 24118
question: Can you please tell me a little bit more about the concept of contingency,
  and how it fits in with historical thinking skills? How can this concept be used
  with K-12 students? Any user-friendly references would be helpful too. I work in
  the field of teacher education and professional development.
url: /teaching-materials/ask-a-master-teacher/24118
image_fid: '6149'
splash_image_fid: '6150'
...
Resources for explicitly teaching K-12 students this concept can be relatively sparse. But some do exist and they run the gamut, from instructional frameworks to particular activities. Historians Thomas Andrews and Flannery Burke suggest using the "5 Cs" to frame history instruction in [this article](http://web.archive.org/web/20131013001943/http://www.historians.org/perspectives/issues/2007/0701/0701tea2.cfm). While their work was developed at the college-level, it can transfer (with modifications) to the K-12 classrooms. Their fourth "C" is contingency and they suggest it may be the most difficult to teach, but their description can help clarify the concept.

UCLA's [National Center for History in the Schools](http://web.archive.org/web/20170519124935/http://nchs.ucla.edu:80/) also includes contingency in the historical thinking skills that students should be learning. Their [standards](http://web.archive.org/web/20170519124935/http://nchs.ucla.edu:80/standards/thinking5-12-3.html) assert that students should "Challenge arguments of historical inevitability by formulating examples of historical contingency, of how different choices could have led to different consequences." (see standard 3.G) These standards also remind us that discrete historical thinking skills are "interactive and mutually supportive" and cannot be taught in the absence of particular historical content.

See this [lesson](http://www.histori.ca/benchmarks/lesson/372) for an example consistent with these recommendations. Located at the [Canadian *Benchmarks of Historical Thinking* site](http://historicalthinking.ca) created by the University of British Columbia’s Centre for the Study of Historical Consciousness, it is a fine example of how to teach this concept. Focused on historical contingency, the lesson integrates this concept with the core historical concepts of causation and change over time to investigate the Chinese experience in Canada.
