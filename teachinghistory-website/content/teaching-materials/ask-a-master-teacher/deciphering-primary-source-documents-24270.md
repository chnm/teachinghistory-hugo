---
title: Deciphering Primary Source Documents
date: '2010-09-29T13:30:26'
lastmod: '2017-12-05T08:46:32'
content_type: ask_an_educator
draft: false
drupal_nid: 24270
question: I'm trying to teach my secondary students how to read documents from the
  18th century (such as letters) and notice how bogged down they get because of the
  complexity and length of the sentences. What tools or advice could I give that would
  help them develop this skill?
url: /teaching-materials/ask-a-master-teacher/24270
image_fid: '6629'
splash_image_fid: '7280'
summary: Create scaffolding and careful preparation of documents to promote student
...
*Modeling* how you read the document can be helpful too. This allows students to see how you also struggle with the language and the strategies you use to make sense of it, like rereading, monitoring your understanding, and asking questions. See [this entry](http://teachinghistory.org/best-practices/teaching-in-action/20795) for an introduction to Reading Apprenticeship, an approach that focuses on reading and thinking aloud together to help students become better readers. Also see historicalthinkingmatters.org for examples of “think-alouds” where students and historians are shown making sense of historical documents using specific historical reading strategies. (find one example [here](http://teachinghistory.org/best-practices/examples-of-historical-thinking/24027).)
...
Teaching some *explicit strategies* can also help. This [guide](http://teachinghistory.org/teaching-materials/teaching-guides/23554) has ideas for teaching students to annotate documents, something that can help them learn to monitor their own understanding and seek out help when needed. Also see work done at the Oakland Unified School District in California for examples of guiding students to figure out what an excerpt says before any analysis. See an example [here](http://www.teachingamericanhistory.us/resources/assessments/assessment08_2.html): scroll down to the question, “Was the creation of the U.S. Constitution good for the people of the United States?” Then look at the assessment and support materials for that question and you will find, on page 4, one example of how they do this.
...
**More Resources**
In our [lesson plan reviews](http://teachinghistory.org/teaching-materials/lesson-plan-reviews), find plans that can inspire ways to work with text that is difficult for students. See [this one](http://teachinghistory.org/teaching-materials/lesson-plan-reviews/24213) on the Preamble to the U.S. Constitution or [this one](http://teachinghistory.org/teaching-materials/lesson-plan-reviews/19572) on the Declaration of Independence. Both of these are for younger students, but both show the necessities of slowing down to read the documents and focusing on short pieces of text.
You may want to also check out [this response](http://teachinghistory.org/teaching-materials/ask-a-master-teacher/19448) that reiterates some of what I've said here.
