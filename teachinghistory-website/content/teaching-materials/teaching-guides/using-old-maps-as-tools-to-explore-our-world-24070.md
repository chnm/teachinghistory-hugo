...
1. **Preparing students**: First take a few minutes to set up the lesson, show students the focus map, explain how it fits into the curriculum, outline the six stages of the lesson using [Handout 1](https://teachinghistory.org/sites/default/files/handout_1-_maps_in_12_steps.pdf), and then describe the end result. Then the class as a whole should develop a context for the map    by addressing the four questions in part one of the handout.
