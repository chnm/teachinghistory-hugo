...
The two [handouts](https://teachinghistory.org/sites/default/files/SAC-Handouts_12.pdf) will help you introduce and set up this activity and there are four [documents](https://teachinghistory.org/sites/default/files/SAC-Documents.pdf) that accompany this SAC. Each dyad should get all four. **Acknowledgments.** We thank Professor Walter Parker at the University of Washington's College of Education for helping us see the enduring value of the SAC approach in the history classroom.