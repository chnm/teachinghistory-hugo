...
> 1. A [background essay](https://www.teachinghistory.org/sites/default/files/2018-08/Background_Essay_Thesis_Guide.pdf) on the Haymarket anarchists
> 2. A set of seven [primary sources](https://www.teachinghistory.org/sites/default/files/2018-08/Primary_Sources_Thesis_Guide.pdf)
> 3. Three student activity sheets—*[What a Thesis Statement Is](https://www.teachinghistory.org/sites/default/files/2018-08/Student_Activity_1_Thesis_Guide.pdf), [What a Thesis Statement Does](https://www.teachinghistory.org/sites/default/files/2018-08/Student_Activity_2_Thesis_Guide.pdf), [Putting the Thesis Statement to Use](https://www.teachinghistory.org/sites/default/files/2018-08/Studend_Activity_3_Thesis_Guide.pdf)*
> 4. [Teacher's Answer Key](https://www.teachinghistory.org/sites/default/files/2018-08/Teachers_Answer_Key_Thesis_Guide.pdf)

## Teacher Preparation

1. Ask students to read the [one-page background essay](https://www.teachinghistory.org/sites/default/files/2018-08/Background_Essay_Thesis_Guide.pdf) provided for this    lesson.
...
3. Have students study the [seven primary sources](https://www.teachinghistory.org/sites/default/files/2018-08/Primary_Sources_Thesis_Guide.pdf) for this lesson, paying    attention both to the content and the sourcing information for each    source.

## In the Classroom

1. Briefly discuss with students the single DBQ used in all three activities    for the lesson.
2. Have students complete [Activity 1](https://www.teachinghistory.org/sites/default/files/2018-08/Student_Activity_1_Thesis_Guide.pdf) and [Activity 2](https://www.teachinghistory.org/sites/default/files/2018-08/Student_Activity_2_Thesis_Guide.pdf). In these activities they    will make several choices among alternative thesis statements, all of which    respond to the lesson's DBQ. If they have read the introductory essay and    studied the sources, these activities will not take much time to complete.
3. Discuss the choices students make for these two activities. The [Teacher's Answer Key](https://www.teachinghistory.org/sites/default/files/2018-08/Teachers_Answer_Key_Thesis_Guide.pdf) sheet for the lesson lists the correct choices and offers    additional ideas to discuss.
4. Ask students to complete [Activity 3](https://www.teachinghistory.org/sites/default/files/2018-08/Studend_Activity_3_Thesis_Guide.pdf) by choosing several sources to use to    back up or qualify one of the thesis statements. Either discuss student    choices in class or ask students to use their notes and their thesis    statement in a brief DBQ essay of their own.
