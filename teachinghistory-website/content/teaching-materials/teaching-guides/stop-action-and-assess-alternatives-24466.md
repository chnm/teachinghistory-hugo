...
* Choose primary source documents, from the varying constituents’ perspectives, to mark critical junctures as the event unfolded. Primary sources, including images, can be found at the Library of Congress’s [Primary Documents in American History](http://www.loc.gov/rr/program/bib/ourdocs/Indian.html) and at its  [American Memory site](http://memory.loc.gov/ammem/index.html).
...
3. Group students by constituency groups:
   > * Members of the [US government on all sides of the issue,](https://teachinghistory.org/sites/default/files/Handout_2_US_Government.pdf)
   > * [Members of the](http://teachinghistory.org/system/files/Handout_2_US_Government.pdf) [Cherokee nation](https://teachinghistory.org/sites/default/files/Handout_1_Cherokee.pdf) on all sides of the issue,
   > * The State of [Georgia](https://teachinghistory.org/sites/default/files/Handout_3_State_of_Georgia.pdf), and
   > * Members of the [press](https://teachinghistory.org/sites/default/files/Handout_4_The_Press.pdf).
