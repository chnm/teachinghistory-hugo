...
5. Based on *A Woman for President*, here's an example of a row from the data chart: ![data chart](/sites/default/files/guidevwchart.jpg "data chart, a woman for president")
