...
* **Borrow:** There are several syllabi available in Guarneri and Davis's [*Teaching American History in a Global Context*](http://books.google.com/books/about/Teaching_American_history_in_a_global_co.html?id=Xf0kAQAAIAAJ). [EDSITEment]( http://edsitement.neh.gov/subject/history-social-studies) has created lists of lessons from their database that are internationalized, (see [here](http://www.thinkfinity.org/community/hub/blog/2012/07/11/edsitements-guide-to-teaching-us-history-from-global-perspective-i)  and [here](http://www.thinkfinity.org/community/hub/blog/2012/07/11/edsitements-guide-to-teaching-us-history-from-a-global-perspective-ii)). Additionally, James Diskant, a high school history teacher, has written about internationalizing the curriculum in [World History Connected](http://worldhistoryconnected.press.illinois.edu/whcindex.html) (see articles starting with Volume 3, Number 3, and running to Volume 5, Number 3, [here](http://worldhistoryconnected.press.illinois.edu/whcindex.html)). Several programs—[International Baccalaureate](http://www.ibo.org/) being the most popular—and schools have instituted global knowledge or citizenship programs as one of their components. Borrow some more: Use Dana Lindaman’s and Kyle Ward’s [*History Lessons: How Textbooks Around the World Portray U.S. History*]( http://thenewpress.com/index.php?option=com_title&task=view_title&metaproductid=1109)  and have students compare accounts of the same events from a U.S. perspective and a foreign perspective. Another way is to use a reader that internationalizes the course. (For examples of readers and other resources mentioned below, see the [Resource List for "Internationalizing" U.S. History handout](http://teachinghistory.org/sites/default/files/internationalizing_u.s._history_0.pdf).)
* **Create:** For each unit choose a lesson or two that you would like to internationalize. Use the *Annals of American History* and the *[Timetables of World History](http://books.google.com/books?id=hJMqAAAAYAAJ&q=timetables+of+history+grun&dq=timetables+of+history+grun&source=bl&ots=SqZ624bB_i&sig=miqY17ODDBAgb7j8Yz64KhZ8kKE&hl=en)* and choose one or more events, movements, or people who can be used for context, comparison, or connection to your event.
* **Focus on Geography:** Use places in the U.S. periodically throughout the course to show the U.S.’s international connections. Salem, MA, and Hawaii are two wonderful examples that allow for study of trade, religion, empire, international business, tourism, the pineapple, and cosmopolitanism. (For relevant texts, see [this handout](http://teachinghistory.org/sites/default/files/internationalizing_u.s._history_0.pdf).)
* **Focus on Biography:** Use individuals who crossed international borders and cultures to infuse a lesson or a lecture with a real example of internationalization. There are many to choose from, including [Abdulrahman Ibrahim ibn Sori](http://www.pbs.org/programs/prince-among-slaves/), Alexander Hamilton, John Quincy Adams, Andrew Carnegie, Emma Goldman, Marcus Garvey, John McCain, [Emily Greene Balch](http://www.nobelprize.org/nobel_prizes/peace/laureates/1946/balch-bio.html), and Robert McNamara. It is also fun for students to [roleplay these individuals in writing](http://worldhistoryconnected.press.illinois.edu/7.3/gregg.html) and in-class activities.
...
See the [Sample Lessons for Internationalizing History](http://teachinghistory.org/sites/default/files/sample_lessons.pdf). The first of these one-day lessons uses a close examination of language to uncover the international nature of the Boston Tea Party and the second lesson uses the same to uncover international connections between the early 19th-century eastern seaboard and other countries and cultures.
