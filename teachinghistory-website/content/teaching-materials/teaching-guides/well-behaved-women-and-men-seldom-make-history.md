...
drupal_nid: 21867
aliases:
- /teaching-materials/teaching-guides/21867
...
1. From the list of [recommended biographies](/files/Recommended_Biographies_of_Women_0.pdf), pick the books you want to use    (four to six is a good number to start with).
...
3. Review the blank data chart found in the [Handouts for Students](/files/Handouts-Picture_Book_Guide.pdf) and each    writing assignment. Make copies as needed.
...
[All examples are from [*A Woman for President: The Story of Victoria Woodhull*](http://openlibrary.org/b/OL7877584M/A_Woman_for_President) (2004) by Kathleen Krull, illustrated by Jane Dyer]
...
5. Based on *A Woman for President*, here's an example of a row from the data chart: ![data chart](/files/guidevwchart.jpg "data chart, a woman for president")
