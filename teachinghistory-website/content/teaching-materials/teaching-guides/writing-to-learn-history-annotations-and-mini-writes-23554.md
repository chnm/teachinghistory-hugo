...
The Spanish-American War unit from [Historical Thinking Matters](http://historicalthinkingmatters.org) investigates the question:

*Why did the United States invade Cuba in 1898?*

To answer this question thoughtfully, students need to consider a range of evidence, multiple causes, and perspectives from the time period. As they analyze [documents in writing](http://historicalthinkingmatters.org/spanishamericanwar/1/materials/worksheets/), students become familiar with the causes of U.S. imperialism in 1898. Handouts help students to use annotations and mini-writes in responding to three documents that relate to the central inquiry question and lead to an evidence-based essay. [Handout 1](https://teachinghistory.org/sites/default/files/2018-08/handout_1-annotation.pdf) models how to annotate a document and offers sample guidelines. [Handout 2](https://teachinghistory.org/sites/default/files/2018-08/handout_2-annotation.pdf) provides guidelines for annotating a second document. [Handout 3](https://teachinghistory.org/sites/default/files/2018-08/Handout_3-Mini-Writes_0.pdf) gives a mini-write prompt in response to an additional document.

## Acknowledgments

I thank teacher Vince Lyle for helping me see the value of annotations and mini-writes in the history classroom. I thank [Historical Thinking Matters](http://historicalthinkingmatters.org) for offering rich document sets, one of which I use here.