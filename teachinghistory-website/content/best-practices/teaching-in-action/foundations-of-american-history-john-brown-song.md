...
drupal_nid: 22158
aliases:
- /best-practices/teaching-in-action/22158
...
Towards the end of the lesson, the teacher facilitates a whole-class review of the [Guiding Question worksheet](http://chnm.gmu.edu/loudountah/lessons/lesson5/BrownBodyGuidingQuestions.pdf ). After students share that they think the song portrayed John Brown as a hero, the teacher refers back to a prior lesson asking, "Do you think this song represents how everybody in the North feels?" Students respond that it does not. The teacher uses this conversation as an opportunity to review that many people in the North did not support John Brown's tactics. Students see that while primary documents are valuable evidence, they should not assume that an individual source speaks for all people. This lesson also draws on multiple classroom resources and incorporates a variety of historical thinking skills. Students use their textbook to help them make sense of the song: they consider the song's historical context and audience. Additionally, you can find a [comprehensive lesson plan](http://web.archive.org/web/20190917041154/http://chnm.gmu.edu/loudountah/source-analysis/john-brown-song/lesson-plan/), complete with additional primary sources, background information, and classroom worksheets, on the site.