...
This museum and school was founded "to keep the legacy of 'Concerned Photography' alive" by bringing the work of more than 3,000 photographers and other artists to the public. The Permanent Collection spans the history of photography, from daguerreotypes of the 18th century to gelatin sliver to digital. About 12,000 images from the ICP collection are available digitally via the ICP's [eMuseum](http://emuseum.icp.org/) (with more forthcoming). The database features simple and advanced search options, and can be browsed by collection or person. The [eMuseum](http://emuseum.icp.org/) also includes brief biographies of many of the photographers in the database.
