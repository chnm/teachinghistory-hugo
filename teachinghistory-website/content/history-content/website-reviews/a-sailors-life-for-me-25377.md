...
draft: false
drupal_nid: 25377
url: /history-content/website-reviews/25377
...
If all of the above isn't impressive enough, the site also offers [educator's resources](http://www.asailorslifeforme.org/family_activities.php>family activities</a> such as baking ship's biscuits, learning about signal flags, and testing buoyancy, as well as <a href=). [Annotated Scenes](http://www.asailorslifeforme.org/educator/annotated_scenes.php) takes each of the interactive scenes discussed earlier; and provides related primary sources, artifacts, activities, videos, interactive games, and lesson plans. [Classroom integration](http://www.asailorslifeforme.org/educator/classroom_integration.php) discusses how best teachers may be able to include the website content in their classroom, and explains its correlation to national standards. [Lesson Plans](http://www.asailorslifeforme.org/educator/lesson_plans.php) let you search activities, lesson plans, artifacts, primary sources, games, and sailors' stories by grade level, content area, and type of resource. Selecting "Social Studies" alone provides 269 options. [War of 1812 Resources](http://www.asailorslifeforme.org/educator/war_of_1812.php) discusses how to teach the war in different classroom time allotments, an overview, a timeline, a brief section on African Americans aboard the *USS Constitution*, and related links and suggested reading.
