---
title: 'Memoirs v. Tapes: President Nixon and the December Bombings'
date: '2012-01-17T17:40:03'
lastmod: '2018-09-25T10:21:08'
content_type: website
draft: false
drupal_nid: 25381
url: /history-content/website-reviews/25381
website_url: https://www.nixonlibrary.gov/
image_fid: '8756'
splash_image_fid: '8757'
summary: Was Nixon as reluctant to initiate the Christmas bombing as his memoirs suggest,
...
The Nixon Presidential Library and Museum recognizes that the audio clips can be difficult to understand. As a result, they have prepared a short list of [tips](http://nixon.archives.gov/exhibits/decbomb/audiotips.html) to help listeners get the most from the sources. In addition, each audio clip has an accompanying log link. The log lists, in bullet form, the topics of conversation covered in the clip.
The [conclusion](http://nixon.archives.gov/exhibits/decbomb/conclusion.html#title) offers a set of five questions to consider after having perused the site and its resources. The questions, such as "What role did the convening of a new Congress play in December 1972 decisions about ending the war?," are, as noted previously, likely most appropriate for high school classrooms. However, it is possible that they may also be of use in middle school, depending on the engagement and ability levels of students.
Finally, the [appendix](http://nixon.archives.gov/exhibits/decbomb/appendix.html#title) offers suggested readings, as well as additional documents, audio and video clips, and photographs which may be of interest.