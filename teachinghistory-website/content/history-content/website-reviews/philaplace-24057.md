...
[Collections](http://www.philaplace.org/collection/) allows visitors to search the more than 1,240 primary sources and audio and video clips available on the site. Filter them by topic, neighborhood, type, or contributor.
The site's [blog](http://blog.philaplace.org/) presents mini-features on certain locations, notifications of updates, and information on professional development and other PhilaPlace-related events. [Educators](http://www.philaplace.org/educators/) provides a timeline for each of the neighborhoods and four suggested lesson plan/activities, while [My PhilaPlace](http://www.philaplace.org/myphilaplace/ ) lets visitors create free accounts and save favorite materials to them—or create their own up-to-25-stop city tour. The [Add a Story](http://www.philaplace.org/addastory/) feature allows visitors to tag locations on the maps with their own short descriptions or memories (up to 600 words long), and accompany them with an image or audio or video clip.
