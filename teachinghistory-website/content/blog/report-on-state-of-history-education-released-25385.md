...
Forty-nine states have history/social studies standards and their content, form, length, and level of detail can vary enormously from state to state. (Iowa is the exception with a [“core” set of “essential concepts and skills”](http://educateiowa.gov/index.php?option=com_content&view=article&id=2471&Itemid=4575) rather than standards.) Teachinghistory.org has recently published a Report on the state of history education and it includes information about those diverse state standards as well as other state policies regarding the teaching of history, including mandatory assessments and initial teacher licensure requirements.
