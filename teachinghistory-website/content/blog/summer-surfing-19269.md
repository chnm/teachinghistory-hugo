...
Among teachers who blog, [Kevin Levin's Civil War Memory](http://cwmemory.com/) is an award-winning blog that covers the broader political, intellectual, and social context of the Civil War, but also looks at best pedagogical practices with films, primary sources, and other instructional tools. California language teacher, Larry Ferlazzo, [blogs about websites](http://larryferlazzo.edublogs.org/) that help teach ESL, EFL, and ELL, including references to sources for history instruction and regular *Ten Best* selections of sites for content and classroom tools.

At [George Mason University's Center for History and New Media](http://web.archive.org/web/20210825024449/https://chnm.gmu.edu/), Director Dan Cohen writes and podcasts about current issues on history, technology, the classroom, and the humanities fields at [Digital Humanities Blog](http://www.dancohen.org). Managing Director Tom Scheinfeldt looks at artifacts, news, technology, and other internet resources in his eclectic blog and podcasts at [Found History](http://www.foundhistory.org).