...
1. **Chronological comparative study**
   Students can create timelines, decade-level synopses, or graphic organizers that align U.S. historical events with the dates of creation of specific comic books, and show how these titles reflected social concerns. (For a nice overview on the history of comic books, Michigan State University's Ethan Wattrell's [course website](http://history.msu.edu/historyofcomics/resources/) contains lecture slides and podcasts that can help orient educators.)
