...
* [Facebook](/digital-classroom/tech-for-teachers/23474) and [Ning](/digital-classroom/tech-for-teachers/20674) allow users to create networks from scratch to imagine what social networks among Bostonian revolutionaries or suffragettes in the early 20th century might talk about. Multiple other free options exist.
* [Twitter](/digital-classroom/tech-for-teachers/21851) lets users publish 140-character updates. What would Abe Lincoln’s Twitter feed look like? What about soldiers on the Pacific front in World War II? [John Quincy Adams](/nhec-blog/22627) is already on Twitter!
* [Skype](/digital-classroom/tech-for-teachers/23569) can help bring scholars and institutions together, establishing relationships with sister cities, schools overseas, and other individuals and organizations.
* [Blogs](/digital-classroom/tech-for-teachers/14590) can become a standard classroom management program (if scholars are not tied to [BlackBoard](http://www.blackboard.com/)), serve as a professional portfolio, or can help historians re-imagine the possibilities for what scholarship on the web looks like.
* [Zotero](/digital-classroom/tech-for-teachers/14585), in a nutshell, functions like digital flashcards and a note-saving device by adding research items from a database ([WorldCat](http://www.worldcat.org/) works well), allowing users to create notes for each entry, and providing tagging, sharing, and publication functions. Zotero is a helpful tool for collaborative projects and archiving research sources over time.
