...
[Printing options](http://www.yourchildlearns.com/megamaps/print-usa-maps.html) for individual maps include size choices. You'll notice that one-page maps are excellent for individual student work, but if you want larger maps, it's necessary to print multiple pages. A 6-foot-wide map is possible, but it prints on 64 individual pages that must then be assembled.

Owl & Mouse offers [suggestions for using their maps](http://www.yourchildlearns.com/megamaps.htm) and instructions for accessing the materials they offer on their site. In addition to maps, their resources include [Reading Software](http://www.yourchildlearns.com/owlmouse.htm#Reading), [Medieval History](http://www.yourchildlearns.com/owlmouse.htm#Medieval), and [Crafts](http://www.yourchildlearns.com/owlmouse.htm#Crafts).