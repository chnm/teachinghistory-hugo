...
There is one overriding thing that we can do to help our students improve their writing: have them write a lot, and write substantively. I have created several posters that I have up in my classroom that relate to the writing that students will undertake in class. One lists the thinking standards that are emphasized in class ("be clear, be accurate, be complete, be deep"; see my [earlier blog entry](/nhec-blog/24977)) and the second contains a quote from Albert Einstein: "You do not understand something until you can explain it to your grandmother." "Everything you write," I tell them, "must be so clear, so accurate, so complete, that even a person who knows nothing of the topic about which you are writing (say your grandmother), will understand it after they have finished reading what you wrote."

## Writing Strategies

**Processing Notebooks**. Students can use writing notebooks to process the varied learning experiences in which they engage. Whatever these experiences, be they interacting with learning stations, viewing a segment from a video, or reading from primary sources or their textbooks, students need to process the information and ideas they are learning. There are many [quick-write strategies](/nhec-blog/25266) that can be used for this processing. Whatever students write, the emphasis should be on clarity and completeness (“make it short and sweet”).
