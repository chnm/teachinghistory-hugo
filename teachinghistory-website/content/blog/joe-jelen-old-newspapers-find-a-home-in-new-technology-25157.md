...
Another lesson idea to help students practice summarizing main ideas is to cover up the headlines of a few articles and have students develop their own. Students can share their headlines aloud or post headlines anonymously [on a wall](http://teachinghistory.org/digital-classroom/tech-for-teachers/24636) to gauge understanding as a whole class.
...
Finally, students could rewrite newspaper articles with new information or using additional eyewitness accounts. By rewriting articles students are forced to detect bias or corroborate additional sources with their assigned newspaper article. For effect, students can create their own newspaper clippings using [this site](http://www.fodey.com/generators/newspaper/snippet.asp).
