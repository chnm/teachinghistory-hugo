...
The TAH program has reached out to U.S. history teachers across the nation since 2001, when it awarded its first 60 grants. Last year, 124 applicants received grants. Learn more about the program at [ED.gov](http://www2.ed.gov/programs/teachinghistory/index.html)—browse the abstracts of previous award recipients, learn how to apply, and read FAQs on eligibility, project priorities, and other topics. If you're applying (or are already a grantee), you may benefit from the Department of Education's [webinars](http://www2.ed.gov/policy/gen/leg/recovery/rms-web-conferences.html) on grant management. Sign up, or read transcripts for past webinars.
Curious to see what others have learned from participating in TAH Grant projects? We have a [section](http://teachinghistory.org/tah-grants) dedicated to highlighting TAH! [Project Spotlights](http://teachinghistory.org/tah-grants/project-spotlight) look at projects that share the resources they've created online, and [Lessons Learned](http://teachinghistory.org/tah-grants/lessons-learned) lets you in on the experiences of educators, project directors, historians, evaluators, and others who have participated in TAH projects.