...
Our site focuses on teaching U.S. history, historical thinking, and historical reading and writing. As a methods instructor, one of my key initial goals is to challenge candidates’ ideas about history (and likely experiences with it as a student) as a memorization game or a story told by the textbook. The nature of history, as an inquiry into the past that demands contextualizing sources and adjudicating between multiple accounts, needs to be made explicit for teacher candidates. There are many ways to do this, and some key resources at Teachinghistory.org can help. These include our *What is Historical Thinking?* [video](/historical-thinking-intro) and a set of “instructional frameworks” for historical thinking listed in [this](/nhec-blog/24434) blog entry.

These historical thinking frameworks are powerful when coupled with demonstrations. Use examples of historical thinking like [this one](/best-practices/examples-of-historical-thinking/24029) of a student contextualizing a document or [this one](/best-practices/examples-of-historical-thinking/23423)  of a historian analyzing three 19th-century objects to help candidates “see” and understand historical thinking. Demonstrate what teaching history as inquiry looks like through using model lessons and then debriefing. Find model lessons in our [*Lesson Plan Reviews*](/teaching-materials/lesson-plan-reviews) or use a sample lesson included in one of our [*Teaching Guides*](/teaching-materials/teaching-guides) to engage candidates in this kind of learning. See [this example](/teaching-materials/teaching-guides/25343) on using webquests or [this one](/teaching-materials/teaching-guides/22365) on using “history book sets."

Short video clips of teachers in their classrooms can be a great way to show this kind of [teaching in action]( /best-practices/teaching-in-action) . For example, [watch](/best-practices/teaching-in-action/23724) these third–graders learn about child labor during the early 20th century. As one methods instructor reported:
...
* *What is Historical Thinking?* [video](/historical-thinking-intro).
