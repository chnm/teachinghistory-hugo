...
Each case opens with a provocative question. [Dropping the Bomb](http://web.wm.edu/hsi/cases/bomb/bomb_preview.html), for example, gives a brief contextual statement about the Manhattan Project and asks "...did Truman *decide* to drop the bomb, or was the use of the atomic bomb inevitable?" The investigative challenge follows a student path and a teacher path through a [four-step instructional model](http://web.wm.edu/hsi/model.html): Becoming a Detective, Investigating the Evidence, Searching for Clues, and Cracking the Case.
