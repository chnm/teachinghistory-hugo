...
We begin by learning as much as we can about the subject. I read books to my students, we listen to information on websites like [pebblego](http://web.archive.org/web/20140527073428/http://www.pebblego.com/login.php), we watch videos, and we talk to each other about what we are learning. Often we will create a [data retrieval chart](/nhec-blog/25361) to help organize all we are learning. If not a data retrieval chart, then we will organize through a web, sorting words, or phrases on cards. Preparing to write a book requires that we take time to reflect on what we have learned and organize the information.
