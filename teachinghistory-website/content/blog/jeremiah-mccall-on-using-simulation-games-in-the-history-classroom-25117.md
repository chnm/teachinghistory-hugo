...
* [*Gaming the Past*](http://books.google.com/books?id=MKFEbwAACAAJ) has a comprehensive index, listing most of the viable simulation games available as of this year. The [*Gaming the Past*]( http://gamingthepast.net/) website lists a portion of those games and is updated several times a year. In my opinion, these are the best places to go for desktop online simulation games (*full disclosure: I wrote the book and designed the website*).
* [Games for Change](http://www.gamesforchange.org/) maintains the most comprehensive lists of games, mostly browser based, designed to tackle serious contemporary issues. The site links directly to the browser-based games to allow easy play.
* [Playing History](http://playinghistory.org/) is a comprehensive listing of online history games, many of which are simulation games. Care is needed to separate more from less useful games.
* Special mention should be made of the [BBC’s Interactive History page](http://www.bbc.co.uk/history/interactive/games/). It contains a number of simple but effective simulations from various parts of British history and more general European history.
