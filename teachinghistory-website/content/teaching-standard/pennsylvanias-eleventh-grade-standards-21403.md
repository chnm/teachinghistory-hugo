---
title: Pennsylvania's Eleventh Grade Standards
date: '2009-02-08T20:16:03'
...
* ### PA.5.1.12. Academic Standard: Civics and Government
  ...
  + #### 5.1.12.A. Standard Statement:

    Evaluate the major arguments advanced for the necessity of government.
  + #### 5.1.12.B. Standard Statement:

    Analyze the sources, purposes and functions of law.
  + #### 5.1.12.C. Standard Statement:

    Evaluate the importance of the principles and ideals of civic life.
  + #### 5.1.12.D. Standard Statement:

    Analyze the principles and ideals that shape the government of Pennsylvania and apply them to the government. (The Charter of 1681, Charter of Privileges, PA Constitution, its revisions and Amendments)
  + #### 5.1.12.E. Standard Statement:

    Evaluate the principles and ideals that shape the United States and compare them to documents of government.
  + #### 5.1.12.F. Standard Statement:

    Analyze and assess the rights of the people as listed in the Pennsylvania Constitution and the Constitution of the United States.
  + #### 5.1.12.G. Standard Statement:

    Analyze and interpret the role of the United States Flag in civil disobedience and in patriotic activities.
  + #### 5.1.12.H. Standard Statement:

    Analyze the competing positions held by the framers of the basic documents of government of Pennsylvania and United States.
  + #### 5.1.12.I. Standard Statement:

    Analyze historical examples of the importance of the rule of law explaining the sources, purposes and functions of law.
  + #### 5.1.12.J. Standard Statement:

    Analyze how the law promotes the common good and protects individual rights.
  + #### 5.1.12.K. Standard Statement:

    Analyze the roles of symbols and holidays in society.
  + #### 5.1.12.L. Standard Statement:

    Analyze Pennsylvania and United States court decisions that have affected principles and ideals of government in civic life. (Civil rights, Commerce, Judicial review, Federal supremacy)
  + #### 5.1.12.M. Standard Statement:

    Evaluate and analyze the importance of significant political speeches and writings in civic life (e.g., Diary of Anne Frank, Silent Spring).
* ### PA.5.2.12. Academic Standard: Civics and Government
...
* ### PA.5.3.12. Academic Standard: Civics and Government
  ...
  + #### 5.3.12.K. Standard Statement:

    Evaluate the strengths and weaknesses of various systems of government. (Autocracy, Democracy, Oligarchy, Republic)
* ### PA.5.4.12. Academic Standard: Civics and Government
  ...
  + #### 5.4.12.D. Standard Statement:

    Explain how foreign policy is developed and implemented.
  + #### 5.4.12.E. Standard Statement:

    Compare the purposes and functions of international organizations. (Governmental (e.g., NATO, World Court, OAS); Non-governmental (e.g., International Red Cross, Amnesty International, World Council of Churches))
* ### PA.6.1.12. Academic Standard: Economics
...
* ### PA.6.5.12. Academic Standard: Economics
...
* ### PA.7.1.12. Academic Standard: Geography
  ...
  + #### 7.1.12.A. Standard Statement:
    ...
    - ##### 7.1.12.A.2 Standard Descriptor:
  ...
  + #### 7.1.12.B. Standard Statement:
    ...
    - ##### 7.1.12.B.2 Standard Descriptor:
...
* ### PA.7.2.12. Academic Standard: Geography
  ...
  + #### 7.2.12.A. Standard Statement: Analyze the physical characteristics of places and regions including the interrelationships among the components of Earth's physical systems

    Biomes and ecosystem regions; Watersheds and river basins; World patterns of biodiversity.
  + #### 7.2.12.B. Standard Statement: Analyze the significance of physical processes in shaping the character of places and regions

    Circulation of the oceans; Ecosystem processes; Atmospheric systems; Extreme natural events.
* ### PA.7.3.12. Academic Standard: Geography
  ...
  + #### 7.3.12.D. Standard Statement:

    Analyze the significance of human activity in shaping places and regions by their economic characteristics.
    - ##### 7.3.12.D.1 Standard Descriptor:
    ...
    - ##### 7.3.12.D.2 Standard Descriptor:
...
* ### PA.7.4.12. Academic Standard: Geography
  ...
  + #### 7.4.12.A. Standard Statement:

    Analyze the impacts of physical systems on people.
    - ##### 7.4.12.A.1 Standard Descriptor:
    ...
    - ##### 7.4.12.A.2 Standard Descriptor:
  ...
  + #### 7.4.12.B. Standard Statement:

    Analyze the impacts of people on physical systems.
    - ##### 7.4.12.B.1 Standard Descriptor:
    ...
    - ##### 7.4.12.B.2 Standard Descriptor:
...
* ### PA.8.1.12. Academic Standard: History
  ...
  + #### 8.1.12.A. Standard Statement: Evaluate chronological thinking

    Sequential order of historical narrative; Continuity and change; Context for events.
  + #### 8.1.12.B. Standard Statement: Synthesize and evaluate historical sources

    Literal meaning of historical passages; Data in historical and contemporary maps, graphs and tables; Different historical perspectives; Data presented in maps, graphs and tables; Visual data presented in historical evidence.
  + #### 8.1.12.C. Standard Statement: Evaluate historical interpretation of events

    Impact of opinions on the perception of facts; Issues and problems in the past; Multiple points of view; Illustrations in historical stories and sources; Connections between causes and results; Author or source of historical narratives' points of view; Central issue.
  + #### 8.1.12.D. Standard Statement: Synthesize historical research

    Historical event (time and place); Facts, folklore and fiction; Historical questions; Primary sources; Secondary sources; Conclusions (e.g., Senior Projects, research papers, debates); Credibility of evidence.
* ### PA.8.2.12. Academic Standard: History
  ...
  + #### 8.2.12.A. Standard Statement:

    Evaluate the political and cultural contributions of individuals and groups to Pennsylvania history from 1890 to Present.
    - ##### 8.2.12.A.1 Standard Descriptor:

      Political Leaders (e.g., Gifford Pinchot, Genevieve Blatt, K. Leroy Irvis).
    - ##### 8.2.12.A.2 Standard Descriptor:

      Military Leaders (e.g., Tasker H. Bliss, Henry 'Hap' Arnold, George C. Marshall).
    - ##### 8.2.12.A.3 Standard Descriptor:

      Cultural and Commercial Leaders (e.g., Milton Hershey, Marian Anderson, Fred Rogers).
    - ##### 8.2.12.A.4 Standard Descriptor:

      Innovators and Reformers (e.g., Frank Conrad, Rachel Carson, Joseph Rothrock).
  + #### 8.2.12.B. Standard Statement:

    Identify and evaluate primary documents, material artifacts and historic sites important in Pennsylvania history from 1890 to Present.
    - ##### 8.2.12.B.1 Standard Descriptor:
    ...
    - ##### 8.2.12.B.2 Standard Descriptor:
  ...
  + #### 8.2.12.C. Standard Statement:

    Identify and evaluate how continuity and change have influenced Pennsylvania history from the 1890s to Present.
    - ##### 8.2.12.C.1 Standard Descriptor:

      Belief Systems and Religions (e.g., Buddhism, Christianity, Hinduism, Islam, Judaism).
    - ##### 8.2.12.C.2 Standard Descriptor:
  ...
  + #### 8.2.12.D. Standard Statement:
    ...
    - ##### 8.2.12.D.5 Standard Descriptor:

      Military Conflicts (e.g., World War I, World War II, Persian Gulf War).
* ### PA.8.3.12. Academic Standard: History
...
* ### PA.8.4.12. Academic Standard: History
  ...
  + #### 8.4.12.B. Standard Statement:
    ...
    - ##### 8.4.12.B.2 Standard Descriptor:
    ...
    - ##### 8.4.12.B.3 Standard Descriptor:

      Historic districts (e.g., Timbuktu, Centre of Mexico City and Xochimilco, Taj Mahal and Gardens, Kremlin and Red Square).
  + #### 8.4.12.C. Standard Statement: Evaluate how continuity and change throughout history has impacted belief systems and religions, commerce and industry, innovations, settlement patterns, social organization, transportation and roles of women since 1450

    Africa; Americas; Asia; Europe.
  + #### 8.4.12.D. Standard Statement: Evaluate how conflict and cooperation among social groups and organizations impacted world history from 1450 to Present in Africa, Americas, Asia and Europe
